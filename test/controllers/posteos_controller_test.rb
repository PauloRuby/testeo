...
class PosteosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create posteo" do
    assert_difference('Posteo.count') do
      post posteos_url, params: { posteo: { cuerpo: @posteo.cuerpo, titulo: @posteo.titulo } }
    end
  ...
  test "should update posteo" do
    patch posteo_url(@posteo), params: { posteo: { cuerpo: @posteo.cuerpo, titulo: @posteo.titulo } }
